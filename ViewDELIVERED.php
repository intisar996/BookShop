...
<div class="dropdown">
 ...
 <?php
	...
	$query1 = "select * from tblbill where   status_bill='Close' ";
	...
	echo "<th  class='col-3' ><font face =arial size =2>ORDER DATE";
     ...
     while($row = mysqli_fetch_assoc($result1)) {
		...
		echo "<td align=center><a href='Admin_ListBill1.php?bill_no=$bill_no&&cusername=$username'><font face =arial size =2 color=red>VIEW BILL</a><br>";
