        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-12 mx-auto">
              ...
              <img src="image/addbook.png" class="rounded-circle p-2 bg-white">
              </div>
              <div class="p-5 bg-white rounded shadow-lg">
                <h3 class="mb-2 text-center pt-5">Update Book </h3>
                ...
                <label class="font-500">Book Name</label>
                  <input name="book_name"  id ="book_name" value="<?php echo "$book_namer"; ?>" class="form-control form-control-lg mb-3" placeholder="Enter Book Type Name" type="text" required>
                <label class="font-500">Book Price</label>
                  <input name="book_price"  id ="book_price" value="<?php echo "$book_pricer"; ?>" class="form-control form-control-lg mb-3" placeholder="Enter Book Price"  pattern="\d+(\.\d+)?" type="number" required>
				...
				<input id="pic" class="form-control form-control-lg mb-3" name="pic" type="file">
                <label class="font-500">Post Date</label>
				<input id="DATE_OR" class="form-control form-control-lg mb-3"  value="<?php echo $adate;?>" name="datepp" type="text" value="<?php echo $adate;?>" readonly="readonly">
                <label class="font-500">Quantity</label>
                <input name="quantity"  id ="quantity" class="form-control form-control-lg mb-3" value="<?php echo "$quantityr"; ?>" placeholder="Enter Book Quantity" type="number" required>
                <label class="font-500">Description:</label>
                <textarea name="book_desc"  id ="book_desc" class="form-control form-control-lg mb-3" placeholder="Enter Description" type="text" required><?php echo "$book_descr"; ?></textarea>
                <label class="font-500">Book Writer:</label>
                <input name="book_writer"  id ="book_writer" class="form-control form-control-lg mb-3" value="<?php echo "$book_writerr"; ?>" placeholder="Enter Book  Writer" type="text" required>
