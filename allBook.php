...
<body>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="allBook.php">All Product</a>
        </li>
        <li class="nav-item">
...
<div class="dropdown">
  ...
  <div class="row">
    <?php
      ...
      $query_count = "SELECT COUNT(*) AS total FROM tblbbook";
      $result_count = mysqli_query($con, $query_count);
      $row_count = mysqli_fetch_assoc($result_count);
      $total_records = $row_count['total'];
      $total_pages = ceil($total_records / $records_per_page);
      
      $query = "SELECT * FROM tblbbook   where  Delete_B = '0' ORDER BY book_price LIMIT $offset, $records_per_page";
    ...
    <div class="col-lg-3 col-md-6 mb-4">
      <div class="card h-100">
        ...
        <div class="card-body">
          <h4 class="card-title"><a href="more.php?book_id=<?php echo $book_id ?>"><?php echo $book_name; ?></a></h4>
