          ...
          <div class="row">
            <div class="col-lg-6 col-12 mx-auto">
              ...
              <div class="p-5 bg-white rounded shadow-lg">
                ...
                <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data" action="Check_UserName.php">
                <label class="font-500">UserName</label>
                  <input name="txtuser" class="form-control form-control-lg mb-3" placeholder="Enter Your Username" type="text" required>
                  <p class="m-0 py-4"></p>
