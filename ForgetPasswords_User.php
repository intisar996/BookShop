...
$q="select * from  tbcustomer where cusername='$username'";
          ...
          <div class="row">
            <div class="col-lg-6 col-12 mx-auto">
              ...
              <div class="p-5 bg-white rounded shadow-lg">
                ...
                <form   method="post"  action="<?php echo "CheckCustomer_Answer.php?cusername=$username";?>" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  >                
