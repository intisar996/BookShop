          ...
          <div class="row">
            <div class="col-lg-6 col-12 mx-auto">
              ...
              <div class="p-5 bg-white rounded shadow-lg">
                <h3 class="mb-2 text-center pt-5">Book Type</h3>
                <form   method="post" id="form2"   name="form2"  onsubmit="return validate(this);"  enctype="multipart/form-data"  action="addtypecode.php">
                
                <label class="font-500">Book Type Name</label>
                  <input name="typ_name"  id ="typ_name" class="form-control form-control-lg mb-3" placeholder="Enter Book Type Name" type="text" required>
